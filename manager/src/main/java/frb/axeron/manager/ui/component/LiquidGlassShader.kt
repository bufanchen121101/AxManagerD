...
// AGSL 液态玻璃 shader。
//
// 来源：FletchMcKee/liquid（Apache-2.0）
//   https://github.com/FletchMcKee/liquid
// 原作者：Colin McKee <https://github.com/FletchMcKee>
//
// 本文件仅在 Android 13 (API 33) 及以上生效 —— RuntimeShader 自 API 33 引入。
// 低版本由调用方降级为 Haze 模糊 + 描边近似。
