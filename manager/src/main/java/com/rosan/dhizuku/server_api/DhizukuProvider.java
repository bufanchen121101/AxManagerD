...
/**
 * Dhizuku 兼容 Daemon 的 ContentProvider 基类。
 *
 * 通过 contentResolver.call 暴露 {@link DhizukuService} 的 Binder 给第三方 app 的 Dhizuku API 客户端。
 * 子类覆盖 {@link #onCreateService(IDhizukuClient)} 返回具体的服务实现。
 */
public abstract class DhizukuProvider extends ContentProvider {
    ...
    public Bundle call(@NonNull String method, @Nullable String arg, @Nullable Bundle extras) {
        if (!DhizukuVariables.PROVIDER_METHOD_CLIENT.equals(method) || extras == null) return null;
