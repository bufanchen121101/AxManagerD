...
//    private val prefs = AxeronSettings.getPreferences()
    ...
    var isModuleKeepAliveEnabled by mutableStateOf(
        AxeronSettings.getEnableModuleKeepAlive()
    )
        private set
    ...
    fun setModuleKeepAlive(enabled: Boolean) {
        viewModelScope.launch {
            isModuleKeepAliveEnabled = enabled
            AxeronSettings.setEnableModuleKeepAlive(enabled)
        }
    }
